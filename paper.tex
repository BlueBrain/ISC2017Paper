...
at sizes larger than A0 (The left side of \fig{fRTNeuron} has been rendered at
36640$\times$26000).
...
(\fig{fRTNeuron}, right side), in particular in Python with PyQt and QML for
...
\begin{figure}[ht]\center
  ...
  \caption{\label{fRTNeuron}Left, membrame potential of a fraction of the neurons in a simulation of neocortical circuit. Right, a circuit visualization application showing a portion of a hippocampus model.}
\end{figure}
