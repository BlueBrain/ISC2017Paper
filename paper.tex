...
at sizes larger than A0 (The original of \fig{fRTNeuron} left is a 36640$\times$26000 pixel image).
...
\begin{figure}[h!t]\center
  \includegraphics[width=.45\columnwidth]{images/rtneuron1.png}\hfil
  \includegraphics[width=.45\columnwidth]{images/rtneuron2.png}
  \caption{\label{fRTNeuron}RTNeuron examples: membrame potential of a fraction of the neurons in a simulation (left) and a circuit visualization application showing a portion of a hippocampus model (right).}
\end{figure}
...
\begin{wrapfigure}{r}{.382\textwidth}\center\vspace{-6ex}
  ...
  {\caption{\label{fZero}New messaging use cases}}\vspace{-6em}
\end{wrapfigure}
